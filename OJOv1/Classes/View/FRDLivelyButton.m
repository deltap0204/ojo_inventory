...
//  FRDLivelyButton.h
//
//  Created by MilosHavel on 2/24/14.
...
-(void) setStyle:(kFRDLivelyButtonStyle)style animated:(BOOL)animated
{
    ...
    if (style == kFRDLivelyButtonStyleHamburger) {
        ...
        newLine1Path = [self createCenteredLineWithRadius:self.dimension/20.0f angle:0 offset:CGPointMake(0, 0)];
        newLine1Alpha = 0.0f;
        newLine2Path = [self createCenteredLineWithRadius:self.dimension/8.0f angle:+M_PI_4 offset:CGPointMake(0, 0)];
        newLine3Path = [self createCenteredLineWithRadius:self.dimension/8.0f angle:-M_PI_4 offset:CGPointMake(0, 0)];
        ...
        newLine1Path = [self createCenteredLineWithRadius:self.dimension/20.0f angle:0 offset:CGPointMake(0, 0)];
        newLine1Alpha = 0.0f;
        newLine2Path = [self createCenteredLineWithRadius:self.dimension/8.0f - self.line2Layer.lineWidth/2.0f angle:-M_PI_4 offset:CGPointMake(0.0f,self.dimension/11.0f)];
        newLine3Path = [self createCenteredLineWithRadius:self.dimension/8.0f - self.line3Layer.lineWidth/2.0f angle:M_PI_4 offset:CGPointMake(0.0f,-self.dimension/11.0f)];
        ...
        newCirclePath = [self createCenteredCircleWithRadius:self.dimension/20.0f];
        newCircleAlpha = 0.0f;
        newLine1Path = [self createCenteredLineWithRadius:self.dimension/8.0f angle:0 offset:CGPointMake(0, 0)];
        newLine1Alpha = 1.0f;
