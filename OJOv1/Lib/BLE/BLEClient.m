...
#if TARGET_OS_IPHONE
    [self.CM scanForPeripheralsWithServices:[NSArray arrayWithObject:[CBUUID UUIDWithString:@SCALE_ETEKCITY_UUID]] options:nil];
#else
...
- (void)centralManager:(CBCentralManager *)central didDisconnectPeripheral:(CBPeripheral *)peripheral error:(NSError *)error {
    ...
    [[self delegate] bleDidDisconnect:error];
    isConnected = false;
}
